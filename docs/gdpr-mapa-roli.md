...
| **Jednotlivý tréning** u samostatného trénera | **najviac 4 roky** od dátumu tréningu (**potvrdené 2026-08-28**) | Absolútny strop, aby uchovávanie nebolo neohraničené — bez neho by hráč trénujúci desať rokov mal v appke desať rokov záznamov. **Bez upozornenia**: oznámené je to v podmienkach, upozorňovať na starnutie každého jedného tréningu by bol len šum. User potvrdil z trénerskej praxe, že 4 roky stačia „aj najväčším puntičkárom" |
| **Záznamy hráča ako celok** u samostatného trénera | **1 rok od posledného tréningu** — potom výzva trénerovi s možnosťou exportu a zmazanie (**potvrdené 2026-08-27**) | Kotví sa na poslednom tréningu, nie na archivácii: návrat hráča hodiny sám reštartuje a upratú sa aj hráči, ktorí ostali formálne aktívni, ale netrénujú. **Export vo výzve je podstatný** — rok je kratší než premlčacia doba, počas ktorej sa dá tréner žalovať, a denník je jeho vlastný dôkaz |
| *(vzťah tých dvoch)* | platí to, čo nastane **skôr** | Dvojica „maximálny vek + nečinnosť" je bežný vzor. Povie sa dvomi vetami: *jednotlivý tréning žije najviac 4 roky, celý záznam o hráčovi zmizne rok po jeho poslednom tréningu* |
| Hráči organizácie | podľa pokynu organizácie v zmluve, **predvolene 2 roky** od ukončenia členstva hráča (**potvrdené 2026-08-29**) | **Trénerské lehoty sa na federácie NEVZŤAHUJÚ** — prevádzkovateľom je zväz, vedie dokumentáciu o celej mládežníckej základni a lehota je jeho rozhodnutie. **Krátka predvolená hodnota je zámer:** zväz, ktorý potrebuje viac, si to vypýta písomne a prevezme za to číslo zodpovednosť sám. Opačne to nefunguje — dlhá predvolená hodnota by znamenala, že údaje o deťoch držíme dlho aj u zákazníka, ktorý o tom nikdy nepremýšľal |
